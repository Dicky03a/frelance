    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 h-14 bg-[#09090f]/80 backdrop-blur-md border-b border-white/5 px-4 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-6">
                <Link href={route('projects.index')} className="text-sm text-white/50 hover:text-white transition-colors">Portofolio</Link>
                <Link href={route('services.index')} className="text-sm text-white/50 hover:text-white transition-colors">Layanan</Link>
                <Link href={route('forum.index')} className="text-sm text-white/50 hover:text-white transition-colors">Forum</Link>
            </div>
